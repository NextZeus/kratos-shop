...
// SetUserID sets the "server" edge to the User entity by id.
func (m *AddressMutation) SetUserID(id int64) {
	m.user = &id
}

// ClearUser clears the "server" edge to the User entity.
func (m *AddressMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared reports if the "server" edge to the User entity was cleared.
func (m *AddressMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "server" edge ID in the mutation.
...
// UserIDs returns the "server" edge IDs in the mutation.
...
// ResetUser resets all changes to the "server" edge.

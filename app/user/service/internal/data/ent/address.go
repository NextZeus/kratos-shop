...
type AddressEdges struct {
	// User holds the value of the server edge.
	User *User `json:"server,omitempty"`
...
func (e AddressEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
			// The edge server was loaded in eager-loading,
			// but was not found.
...
// QueryUser queries the "server" edge of the Address entity.

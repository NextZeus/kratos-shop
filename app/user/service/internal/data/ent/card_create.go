...
// SetNillableUserID sets the "server" edge to the User entity by ID if the given value is not nil.
...
// SetUser sets the "server" edge to the User entity.
...
// check runs all checks and server-defined validators on the builder.
